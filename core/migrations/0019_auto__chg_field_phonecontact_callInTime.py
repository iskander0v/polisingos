...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhoneContact.callInTime'
        db.alter_column('core_phonecontact', 'callInTime', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'PhoneContact.callInTime'
        db.alter_column('core_phonecontact', 'callInTime', self.gf('django.db.models.fields.TimeField')(default=1))
    ...
    models = {
        ...
        'core.phonecontact': {
            ...
            'callInTime': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
