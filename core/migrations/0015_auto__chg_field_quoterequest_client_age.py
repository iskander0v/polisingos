...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuoteRequest.client_age'
        db.alter_column('core_quoterequest', 'client_age', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'QuoteRequest.client_age'
        db.alter_column('core_quoterequest', 'client_age', self.gf('django.db.models.fields.IntegerField')(default=0))
