...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.in_helpful_category'
        db.add_column('core_article', 'in_helpful_category',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.in_helpful_category'
        db.delete_column('core_article', 'in_helpful_category')
