...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsuranceProgramm.table'
        db.add_column('core_insuranceprogramm', 'table',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsuranceProgramm.table'
        db.delete_column('core_insuranceprogramm', 'table')
