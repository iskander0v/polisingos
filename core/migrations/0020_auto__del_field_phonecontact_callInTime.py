...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhoneContact.callInTime'
        db.delete_column('core_phonecontact', 'callInTime')


    def backwards(self, orm):
        # Adding field 'PhoneContact.callInTime'
        db.add_column('core_phonecontact', 'callInTime',
