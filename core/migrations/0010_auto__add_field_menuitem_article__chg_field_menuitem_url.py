...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuItem.article'
        db.add_column('core_menuitem', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Article'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'MenuItem.url'
        db.alter_column('core_menuitem', 'url', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
        # Adding index on 'MenuItem', fields ['url']
        db.create_index('core_menuitem', ['url'])


    def backwards(self, orm):
        # Removing index on 'MenuItem', fields ['url']
        db.delete_index('core_menuitem', ['url'])

        # Deleting field 'MenuItem.article'
        db.delete_column('core_menuitem', 'article_id')


        # Changing field 'MenuItem.url'
        db.alter_column('core_menuitem', 'url', self.gf('django.db.models.fields.URLField')(default='/', max_length=200))
