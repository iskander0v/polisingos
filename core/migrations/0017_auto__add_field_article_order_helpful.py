...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.order_helpful'
        db.add_column('core_article', 'order_helpful',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.order_helpful'
        db.delete_column('core_article', 'order_helpful')
