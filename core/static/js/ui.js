...
(function($) {
	$.fn.refreshSelect = function(o) {
		...
		_this.each(function(){
			var selectVal = $(this).attr("newVal") ? $(this).attr("newVal") : $(this).val();
			$(this).data("selectmenu").newelement.add($(this).data("selectmenu")._optionLis.parents(".ui-selectmenu-menu")).remove();
			if (_option) {
		...
		_this.selectmenu({style:'dropdown'});
	};
})(jQuery);

$(function(){
	$('select:not(.day .month)').selectmenu({style:'dropdown'});
});